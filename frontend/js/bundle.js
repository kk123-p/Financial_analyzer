...
function getFallbackModules() {
  return [
    ...
    { key: 'combined', category: 'market', name: '量价结合', desc: '股价走势与财务表现相关性、背离异常信号', output: 'text', available: true },
    { key: 'balance_sheet_analysis', category: 'financial', name: '资产负债表', desc: '资产结构、负债结构、偿债能力、营运效率 7节深度', output: 'text', available: true },
    ...
    { key: 'textbook_ratios', category: 'capability', name: '教科书比率分析', desc: 'Ch5 教科书标准财务比率计算', output: 'text', available: true },
    ...
    { key: 'quadrant', category: 'deep', name: '现金流象限', desc: '8象限分类(奶牛/成长/困境...)、生命周期判断', output: 'text', available: true },
